...
{
public:
    // g2o information-matrix scaling multipliers.
    // 1.0 = no change (default).
    static float weightVision_;
    static float weightIMU_;

    static void setWeightMultipliers(const float weightVision, const float weightIMU)
    {
        weightVision_ = weightVision;
        weightIMU_ = weightIMU;
    }
